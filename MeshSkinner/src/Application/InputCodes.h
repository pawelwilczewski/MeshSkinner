...
// ------------------------------
// DEFINITIONS TAKEN FROM glfw3.h
// ------------------------------
 ...
 */
constexpr int KEY_MOD_SHIFT = 0x0001;
/*! @brief If this bit is set one or more Control keys were held down.
 *
 *  If this bit is set one or more Control keys were held down.
 */
constexpr int KEY_MOD_CONTROL = 0x0002;
/*! @brief If this bit is set one or more Alt keys were held down.
 *
 *  If this bit is set one or more Alt keys were held down.
 */
constexpr int KEY_MOD_ALT = 0x0004;
/*! @brief If this bit is set one or more Super keys were held down.
 *
 *  If this bit is set one or more Super keys were held down.
 */
constexpr int KEY_MOD_SUPER = 0x0008;
/*! @brief If this bit is set the Caps Lock key is enabled.
*
*  If this bit is set the Caps Lock key is enabled and the @std::shared_ptr
*  GLFW_LOCK_KEY_MODS input mode is set.
*/
constexpr int KEY_MOD_CAPS_LOCK = 0x0010;
/*! @brief If this bit is set the Num Lock key is enabled.
 *
 *  If this bit is set the Num Lock key is enabled and the @std::shared_ptr
 *  GLFW_LOCK_KEY_MODS input mode is set.
 */
constexpr int KEY_MOD_NUM_LOCK = 0x0020;
 ...
 *
 *  See [mouse button input](@std::shared_ptr input_mouse_button) for how these are used.
 *
 *  @ingroup input
 *  @{ */
...
constexpr int MOUSE_BUTTON_LAST = MOUSE_BUTTON_8;
 ...
 *  @brief Joystick IDs.
 *
 *  See [joystick input](@std::shared_ptr joystick) for how these are used.
 *
 *  @ingroup input
 *  @{ */
 ...
 *
 *  See @std::shared_ptr gamepad for how these are used.
 *
 *  @ingroup input
 *  @{ */
