...
BoneGPU::BoneGPU(Bone &bone, const glm::mat4 &inverseRootWorldMatrix) : modelMatrix(inverseRootWorldMatrix * bone.GetWorldMatrix()), inverseBindMatrix(bone.inverseBindMatrix)
{
